	...
	public static void main(String[] args) {
		...
		do {
			try {
				...
				BufferedReader br = new BufferedReader(new FileReader("leerFicheros/ejercicios/Ej4LeerYOrdenarAlfabeticamente.java"));
				...
				BufferedWriter bw = new BufferedWriter(new FileWriter("leerFicheros/"+nuevonombre+"2version"+extension));
//////////////PRUEBAS/////////////////////////////////
...
//				 TODO Bloque catch generado automáticamente
				e.getMessage();
				encontrado = false;
				System.out.println("No Se encontro tu archivo, vuelve a mirar\nIntroduzca 0 si desea salir del programa");
				ruta=s.next();
			} catch (IOException e) {
//				 TODO Bloque catch generado automáticamente
				e.getMessage();

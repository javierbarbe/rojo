...
public class Personaje {
	...
	final String[] oficios = { "Barbaro", "Bailarin guerrero", "Tanque", "Mago", "Ladron" };
	private String raza;
...
//		}
		...
		if (this.raza.equalsIgnoreCase("elfo")) {
		 ...
		 if (this.oficio.equalsIgnoreCase("Barbaro")) {
			resistencia+=3;
			vida+=4;
			daño+=5;
			magia-=2;
		}	
		 if (this.oficio.equalsIgnoreCase("Ladron")) { //10 puntos 
			resistencia+=2;
			vida+=4;
			daño+=3;
			magia+=1;
		}
		 if (this.oficio.equalsIgnoreCase("Bailarin guerrero")) { //10 puntos 
			resistencia+=3;
			vida+=3;
			daño+=4;
			magia+=0;
